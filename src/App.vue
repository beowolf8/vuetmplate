                ...
                <div class="col-sm-7">
                  <div class="single-welcome-hero">
                    <div class="welcome-hero-txt">
                      <h4>Фрезерная обработка металла</h4>
                      <h2>Изготовление пресс-форм и штампов </h2>
                      <p>
                        Пресс-формы для литья пластика и алюминия, а также для компрессионного прессования ректопластичных композитных материалов. Штампы для холодной штамповки. Наши производственные мощности позволяют выпускать до 200 пресс-форм и 100 штампов в год. Благодаря большому опыту наших конструкторов и технологов мы можем разрабатывать оснастку для различных технологий переработки.
                      </p>
                ...
                <div class="col-sm-7">
                  <div class="single-welcome-hero">
                    <div class="welcome-hero-txt">
                      ...
                      <h2>Изготовление деталей на заказ</h2>
                      <p>
                        Производим токарную обработку металла по чертежам заказчика или по эскизу заказчика, на высокоточных станках с ЧПУ с приводным инструментом. 
                      </p>
                      <div class="packages-price">
                        <p>
                          Цена от 10р
            ...
            <div class="welcome-hero-content">
              <div class="row">
                <div class="col-sm-7">
                  <div class="single-welcome-hero">
                    <div class="welcome-hero-txt">
                      <h4>Литье пластика</h4>
                      <h2>Изготовление деталей из пластика и реактопластов</h2>
                      <p>
                        Литье пластиковых деталей на современных ТПА (ТПА - термопласт автомат), изготовление деталей из реактопластов на вертикальных прессах.  
                      </p>
                      <div class="packages-price">
                        <p>
                          Цена от 1р
            ...
            <div class="welcome-hero-content">
              <div class="row">
                <div class="col-sm-7">
                  <div class="single-welcome-hero">
                    <div class="welcome-hero-txt">
                      <h4>Литье алюминия</h4>
                      <h2>Изготовление деталей из алюминия</h2>
                      <p>
                        Литье деталей из алюминия на машине с усилием смыкания 280 тонн. Масса отливки до 4кг. 
                      </p>
                      <div class="packages-price">
                        <p>
                          Цена от 50р
                ...
                <div class="col-sm-5">
                  <div class="single-welcome-hero">
                    <div class="welcome-hero-img">
                      <img src="assets/images/slider4.png" alt="slider image">
                    </div><!--/.welcome-hero-txt-->
                  </div><!--/.single-welcome-hero-->
                </div><!--/.col-->
              </div><!--/.row-->
        ...
        <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"  data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
            ...
            <div class="container">            
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">ЧЗПЭ</a>
                </div><!--/.navbar-header-->
                ...
                <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="scroll"><a href="#new-arrivals">услуги</a></li>
                        <li class="scroll"><a href="#feature">парк станков</a></li>
                        <li class="scroll"><a href="#blog">статьи</a></li>
                        <li class="scroll"><a href="#newsletter">контакты</a></li>
                    </ul><!--/.nav -->
                </div><!-- /.navbar-collapse -->
            </div><!--/.container-->
        </nav><!--/nav-->
...
<!--welcome-hero end -->
<!--product-samples start -->
<section id="product-samples" class="product-samples">
  <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals1.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="sale bg-1">
                <p>sale</p>
              </div>
              <div class="product-sample-cart">
                <p>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals2.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="sale bg-2">
                <p>sale</p>
              </div>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals3.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="product-sample-cart">
                <p>
                  <span class="lnr lnr-cart"></span>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals4.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="sale bg-1">
                <p>sale</p>
              </div>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals5.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="product-sample-cart">
                <p>
                  <span class="lnr lnr-cart"></span>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals6.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="sale bg-1">
                <p>sale</p>
              </div>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals7.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="sale bg-2">
                <p>sale</p>
              </div>
        ...
        <div class="col-md-3 col-sm-4">
          <div class="single-product-sample">
            <div class="single-product-sample-bg">
              <img src="assets/images/arrivals8.png" alt="product-samples images">
              <div class="single-product-sample-bg-overlay"></div>
              <div class="product-sample-cart">
                <p>
                  <span class="lnr lnr-cart"></span>
